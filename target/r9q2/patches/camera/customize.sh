# Usuń lub zakomentuj linię powodującą błąd (camera-feature.xml)
# ADD_TO_WORK_DIR "$DEVICE_DIR/camera/camera-feature.xml" "system" "system/cameradata/camera-feature.xml"

# Dodawanie bibliotek Samsunga
...
# Usuwanie konfliktującej biblioteki
DELETE_FROM_WORK_DIR "system" "system/lib64/libdualcam_refocus_image.so"

# Fix Portrait (Naprawa trybu portretowego)
